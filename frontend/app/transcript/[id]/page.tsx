      ...
      <nav className="border-b border-gray-200 dark:border-gray-800 glass-effect sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/dashboard" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-purple-600 transition-colors">
            ...
            <div className="space-y-4">
              {transcript?.segments.map((segment) => (
                <div
                  ...
                  className="border-l-4 border-purple-600 pl-4 py-2 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors rounded-r"
                >
